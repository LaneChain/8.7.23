...
public class Scrape extends JFrame {
   ...
   // JTextField tfRegex;
    JButton btnSubmit;
    String[] regValues = {  "[0-9]{3}-[0-9]{3}-[0-9]{4}" ,             //phones: 
                "[a-zA-Z]+@stmartin\\.edu",   //emails: 
                "[a-zA-Z]+@[a-zA-Z]+\\.[a-zA-Z]+" //fancier emails
            };
            ...
            while( (line=br.readLine()) != null)
            {
                ...
                while(m.find())
                {
                    tblModel.insertRow(tblModel.getRowCount(), 
                                      new Object[]{String.valueOf(tblModel.getRowCount()+1), m.group()});
                }
            }
